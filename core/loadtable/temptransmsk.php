...
$columns = array(
    ...
    array( 'db' => 'kode_rekening', 'dt' => 6 ),
    array( 'db' => 'nilai_kontrak', 'dt' => 7, 'formatter' => function($d,$row){return "Rp. &nbsp;&nbsp;".number_format($d,2,",",".");}),
    array( 'db' => 'ket_rek', 'dt' => 8 ),
    array( 'db' => 'error_message', 'dt' => 9 )
);
