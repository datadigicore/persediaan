...
--
-- Table structure for table `temp_import_masuk`
--

CREATE TABLE `temp_import_masuk` (
  `id` int(11) NOT NULL,
  ...
  `qty_akhir` decimal(50,2) DEFAULT NULL,
  `harga_sat` decimal(50,2) NOT NULL,
  `total_harga` decimal(50,2) DEFAULT NULL,
  `kode_rekening` varchar(16) NOT NULL,
  `nama_rekening` varchar(64) NOT NULL,
  `nilai_kontrak` decimal(50,2) NOT NULL DEFAULT '0.00',
  `ket_rek` varchar(60) DEFAULT NULL,
...
--
-- Indexes for table `temp_import_masuk`
--
ALTER TABLE `temp_import_masuk`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `temp_import_masuk`
--
ALTER TABLE `temp_import_masuk`
