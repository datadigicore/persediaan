  ...
  <body class="skin-blue">
            ...
            <section class="col-lg-12 connectedSortable">
              <div class="box box-info">
                ...
                <form action="../core/transaksi/prosestransaksi" method="post" id="formSave">
                  <input type="hidden" name="manage" value="add_temp_item_trans_keluar">
                </form>
    ...
    <script type="text/javascript">
      ...
      $.ajax({
        ...
        data: {manage:'readidenttempitemklr'},
        dataType: "json",
      ...
      $.ajax({
        type: "post",
        url: '../core/transaksi/prosestransaksi',
        data: {manage:'checkErrorMessage',jenis:'keluar'},
        success: function (output) {
          errormessage = output;
        }
      });
      table = $("#example1").DataTable({
        ...
        "processing": false,
        "serverSide": true,
        "ajax": "../core/loadtable/temptransklr",
        "columnDefs":
        [
          {"targets": 0,
           "visible": false },
        ...
        "rowCallback": function( row, data, index ) {
          if (!data[2] && data[3] == 0) {
            ...
            $(row).html('<td>'+data[1]+'</td><td colspan="1" style="text-align:center">Transaksi Non Persediaan</td><td>'+data[6]+'</td><td>'+data[7]+'</td><td>'+data[8]+'</td><td>'+data[9]+'</td>');
